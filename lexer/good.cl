...
(* abc ...
*)
invalid characters in comment should be ok:
> & % # @ ? ~
below are random keywords to make sure the lexer know they are still comments:
class
true false if
End of comment
*)
...
class Main inherits IO {
    ...
    c: Int <- a + 1;  -- Adding integers correctly
    classified: Int; -- Making sure "class" keyword and "classified" ident isn't mixed up
    ...
    -- A method with multiple arguments and an if-else condition
    ...
    main() : Object {{
        ...
        let count: Int <- 5 in {
            ...
            out_string(b);  -- Output a string from a field
        };
    }};
};